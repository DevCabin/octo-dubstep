<?php
/**
 * Dakota Plains functions and definitions
 *
...
if ( ! function_exists( 'dakota_plains_setup' ) ) :
/**
 ...
 */
function dakota_plains_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Dakota Plains, use a find and replace
	 * to change 'dakota-plains' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'dakota-plains', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'dakota-plains' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'dakota_plains_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // dakota_plains_setup
add_action( 'after_setup_theme', 'dakota_plains_setup' );
 ...
 */
function dakota_plains_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'dakota-plains' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'dakota_plains_widgets_init' );
...
function dakota_plains_scripts() {
	//styles
	// Bootstrap
	wp_enqueue_style( 'dakota-plains-bs-style', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '20141031', 'all' );
	wp_enqueue_style( 'dakota-plains-bs-theme', get_template_directory_uri() . '/css/bootstrap-theme.min.css', array(), '20141031', 'all' );
	// Slick (you know, the slider slider you'll ever need)
	wp_enqueue_style( 'dakota-plains-slick-style', get_template_directory_uri() . '/css/slick.css', array(), '20141031', 'all' );
